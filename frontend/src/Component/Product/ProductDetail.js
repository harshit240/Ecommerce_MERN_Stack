            ...
            <div className="container-fluid pb-5">
                <div className="row px-xl-5">
                    <div className="col-lg-5 mb-30">
                        <div id="product-csarousel" className="carousel slide" data-ride="carousel">
                            <div className="carousel-inner bg-light">
                                <div className="carousel-item active">
                                    <img className="w-100 h-100" src={products?.images && products?.images.url} alt="Img" />
                                </div>
                    ...
                    <div className="col-lg-7 h-auto mb-30">
                        <div className="h-100 bg-light p-30">
                            ...
                            <div className="d-flex align-items-center mb-4 pt-2">
                                ...
                                <Link to={'/cart'}>
                                    <button className="btn btn-primary px-3"><i className="fa fa-shopping-cart mr-1" onClick={addToCartHandler()}></i> Add To
                                        Cart</button>
                                </Link>
                            </div>
                                    ...
                                    <div className="row">
                                        <div className="col-md-6">
                                            ...
                                            <div className="media mb-4">
                                                <img src="/img/user.jpg" alt="Img" className="img-fluid mr-3 mt-1" style={{ width: "45px" }} />
