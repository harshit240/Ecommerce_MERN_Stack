                ...
                <div className="form-group">
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="form-group">
                      ...
                      <input type="text" value={name || ''} name='name' onChange={(e) => setName(e.target.value)} className='form-control' id="inputName" aria-describedby="nameHelp" />
                    </div>
                    <div className="form-group">
                      <label htmlFor="inputEmail">Email address</label>
                      <input type="email" value={email || ''} name='email' onChange={(e) => setEmail(e.target.value)} className='form-control' id="inputEmail" aria-describedby="emailHelp" />
                    </div>
                    {/* <div className="form-group">
